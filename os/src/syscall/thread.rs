...
pub fn sys_thread_create(entry: usize, arg: usize) -> isize {
    ...
    while process_inner.tasks.len() < new_task_tid + 1 {
        ...
        process_inner.allocation_mutex_list.push(vec![0; mutex_len]);
        process_inner.allocation_semaphore_list.push(vec![0; semaphore_len]);
        process_inner.need_list.push(vec![0; semaphore_len]);
    }
